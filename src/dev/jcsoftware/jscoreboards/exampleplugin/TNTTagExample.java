...
import dev.jcsoftware.jscoreboards.JScoreboardPlayerTeam;
import dev.jcsoftware.jscoreboards.exception.JScoreboardException;
import org.bukkit.Bukkit;
import org.bukkit.entity.Player;
import org.bukkit.plugin.java.JavaPlugin;

public class TNTTagExample extends JavaPlugin {

    private JScoreboard scoreboard;
    private JScoreboardPlayerTeam taggedTeam;
    ...
    public void onEnable() {
        ...
        this.scoreboard = new JScoreboard(new JScoreboardOptions("&4&lTNT&f&lTag", false));
